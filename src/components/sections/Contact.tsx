...
const ContactSection = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-green-50 to-green-50 py-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Schedule a demo or reach out to learn how AgriSense Solutions can optimize your farming operations
          </p>
        </div>
